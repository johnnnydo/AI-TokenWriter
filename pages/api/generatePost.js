    ...
    messages: [
      {
        role: "system",
        content:
          "You are an SEO friendly blog post generator called AI-TokenWriter. You are designed to output markdown without frontmatter.",
      },
      {
        role: "user",
        content: `
    ...
    messages: [
      {
        role: "system",
        content:
          "You are an SEO friendly blog post generator called AI-TokenWriter. You are designed to output JSON. Do not include HTML tagw in your output.",
      },
      {
        role: "user",
        content: `
